...
export const MOCK_CATEGORIES: Category[] = [
  {
    ...
    slug: 'audio',
    description: 'High-fidelity spatial sound gear, active noise cancellation, & audiophile studio monitors.',
  ...
  },
  {
    ...
    name: 'Wearable Tech',
    slug: 'wearables',
    description: 'Biometric smartwatches, titanium activity trackers, & augmented reality eyewear.',
  ...
  },
  {
    ...
    slug: 'keyboards',
    description: 'Custom mechanical keyboards with hot-swappable switches and custom keycaps.',
  ...
  },
  {
    ...
    slug: 'workspace',
    description: 'Ergonomic desk setups, ambient lightbars, and wireless charging pads.',
...
export const MOCK_PRODUCTS: Product[] = [
  {
    ...
    description: 'Experience ultra-pure spatial sound with customized 40mm planar magnetic drivers. Features active noise cancellation up to -45dB, 60-hour battery life, and ultra-plush memory foam earcups encased in anodized aerospace aluminum.',
    specs: {
    ...
    variants: [
      { name: 'Color', options: ['Matte Obsidian', 'Starlight Silver', 'Cyber Violet'] },
    ],
    rating_avg: 4.9,
    reviews_count: 128,
    created_at: new Date().toISOString(),
  ...
  },
  {
    ...
    description: 'Crafted from grade-5 titanium with a sapphire glass AMOLED display. Continuous heart-rate, SpO2 tracking, ECG monitoring, and dual-frequency GPS navigation with up to 14 days of battery.',
    specs: {
    ...
    variants: [
      { name: 'Band', options: ['Titanium Link', 'Sport Silicone', 'Leather Strap'] },
    ],
    rating_avg: 4.8,
    reviews_count: 89,
    created_at: new Date().toISOString(),
  ...
  },
  {
    ...
    description: 'Full CNC aluminum chassis with gasket mount structure, sound-dampening foam layers, and pre-lubed linear switches. Customizable per-key RGB backlighting and QMK/VIA compatibility.',
    specs: {
    ...
    variants: [
      { name: 'Switch', options: ['Butter Linear', 'Silent Tactile', 'Clicky Jade'] },
    ],
    rating_avg: 4.95,
    reviews_count: 210,
    created_at: new Date().toISOString(),
  ...
  },
  {
    ...
    description: 'Dual light source desk lamp with zero-screen-glare optical geometry and back ambient RGB sync mode. Wirelessly controlled with an aluminum touch knob.',
    specs: {
    ...
    variants: [
      { name: 'Finish', options: ['Space Gray', 'Pure White'] },
    ],
    rating_avg: 4.7,
    reviews_count: 64,
    created_at: new Date().toISOString(),
...
export const MOCK_REVIEWS: Review[] = [
  {
    ...
    rating: 5,
    comment: 'The soundstage on these planar magnetic drivers is unreal! The active noise cancellation easily blocks out office noise and subway rumble. 10/10 portfolio product!',
  ...
  },
  {
    ...
    rating: 5,
    comment: 'Super fast shipping and premium packaging. The memory foam earcups feel weightless even after an 8-hour editing session.',
  ...
  order_items: [
    {
      ...
      product_image: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=1000&q=80',
